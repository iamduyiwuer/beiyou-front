<template>
  <div>
      ...
      <el-table :data="roleList" border stripe>
        ...
        <el-table-column type="expand">
          <template slot-scope="scope">
            <el-row :class="['bdbottom', i1 == 0 ? 'bdtop' : '', 'vcentor']" v-for="(item1, i1) in scope.row.children"
                    :key="item1.id">
              <!-- 渲染一级权限-->
              <el-col :span="5">
    ...
    <el-dialog
      ...
      <!-- 树形控件 -->
      <el-tree :data="rightsListTree" :props="treeProps" show-checkbox node-key="id" default-expand-all
